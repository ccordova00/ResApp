...
namespace ResApp.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ApplicantID,Description,YearsExp,Priority,IDCategory")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,YearsExp,Priority,IDCategory")] Skill skill)
        {
            if (id != skill.ID)
            {
                return NotFound();
